...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      ...
      <div class="form-group form-span-2">
        <label><input type="checkbox" name="show_location" value="1" style="width:auto;display:inline-block;" <?php echo e(old('show_location', $setting->show_location ?? true) ? 'checked' : ''); ?>> Tampilkan section Lokasi di halaman Kontak</label>
      ...
      <div class="form-group form-span-2">
        ...
        <input type="url" name="maps_embed_url" value="<?php echo e(old('maps_embed_url', $setting->maps_embed_url)); ?>" placeholder="https://www.google.com/maps/embed?pb=...">
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Khalish\Documents\Pustekinfo_DPR-RI\resources\views/admin/settings/edit.blade.php ENDPATH**/ ?>