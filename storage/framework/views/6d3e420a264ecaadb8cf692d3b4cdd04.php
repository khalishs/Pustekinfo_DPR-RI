...
<body <?php if($__syncResource): ?> data-sync-resource="<?php echo e($__syncResource); ?>" <?php endif; ?>>
  <aside class="sidebar">
    ...
    <nav>
      ...
      <details class="nav-group" open>
        ...
        <a href="<?php echo e(route('admin.location-settings.edit')); ?>" class="<?php echo e(request()->routeIs('admin.location-settings.*') ? 'active' : ''); ?>">
  ...
  <script>
    ...
    (function(){
      var message = <?php echo json_encode(session('success'), 15, 512) ?>;
      if (!message) return;
    ...
    (function(){
      var message = <?php echo json_encode(session('error'), 15, 512) ?>;
      if (!message) return;
