            ...
            <form action="<?php echo e(route('admin.login.post')); ?>" method="POST" class="space-y-5">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="login" id="login" autocomplete="username"
                        ...
                        placeholder="Username admin" required value="<?php echo e(old('login')); ?>">
                </div>
...
<?php /**PATH C:\Users\Khalish\Documents\Pustekinfo_DPR-RI\resources\views/admin/login.blade.php ENDPATH**/ ?>