{{-- resources/views/admin/settings/location.blade.php --}}
    ...
    <div class="form-grid">
      <div class="form-group form-span-2" style="display:flex;align-items:center;gap:12px;">
        <label class="toggle-switch">
          <input type="checkbox" name="show_location" value="1" {{ old('show_location', $setting->show_location ?? true) ? 'checked' : '' }}>
      ...
      <div class="form-group form-span-2">
        ...
        <input type="url" name="maps_embed_url" id="mapsEmbedUrl" value="{{ old('maps_embed_url', $setting->maps_embed_url) }}" placeholder="https://www.google.com/maps/embed?pb=...">
