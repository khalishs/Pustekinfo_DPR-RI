...
@if($statistics->count() >= $maxStats)
  <p style="margin:-8px 0 16px;font-size:12.5px;color:#8a97a0;font-weight:600;">Maksimal {{ $maxStats }} data statistik sudah tercapai. Hapus salah satu untuk menambah yang baru.</p>
@endif
<div class="card">
