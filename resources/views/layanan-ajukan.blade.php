...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .konten-batik::before{
    ...
    background-image:url('{{ asset('images/pola-batik.png') }}');
    background-repeat:no-repeat;background-position:center top;background-size:5000px auto;
...
<body>
  ...
  <svg width="0" height="0" style="position:absolute;overflow:hidden" aria-hidden="true">
    <filter id="batikAlphaBoost"><feComponentTransfer><feFuncA type="linear" slope="4.5" intercept="0"/></feComponentTransfer></filter>
