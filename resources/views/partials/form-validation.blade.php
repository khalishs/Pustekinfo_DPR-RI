{{-- resources/views/partials/form-validation.blade.php
     Ganti validasi "wajib diisi"/format bawaan browser (balon native Chrome dkk)
     dengan pesan error buatan sendiri, dan cegah form pindah/reload halaman kalau
     ada isian yang belum valid. Dipakai bareng di admin panel & halaman publik
     (kontak, ajukan layanan, cek status layanan, login) — cukup include sekali
     di tiap halaman yang punya <form>. Aturan required/type/min/max/pattern di
     HTML tetap dipakai apa adanya lewat Constraint Validation API bawaan
     browser, cuma tampilannya yang diganti. --}}
<script>
  (function(){
