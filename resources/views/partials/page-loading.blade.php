{{-- resources/views/partials/page-loading.blade.php
     Indikator loading buat halaman publik (beranda, profil, layanan, dst):
     progress bar tipis di atas + popup logo Pustekinfo yang berputar, muncul
     tiap pindah halaman (klik link) atau submit form. Dipakai bareng di semua
     halaman publik — cukup include sekali sebelum </body>. Warna pakai
     var(--navy/--teal/--gold/--white) milik tiap halaman kalau ada, dengan
     fallback ke warna brand default supaya tetap aman di halaman yang belum
     mendefinisikan variabel itu (mis. login.blade.php yang berbasis Tailwind). --}}
<style>
  .pub-loading-bar{
    ...
    overlay.innerHTML =
      '<div class="pub-loading-box">' +
        '<div class="pub-loading-orbit">' +
          '<img src="{{ asset('images/Logo.png') }}" alt="Logo Pustekinfo" class="pub-loading-logo">' +
        '</div>' +
