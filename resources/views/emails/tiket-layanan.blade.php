{{-- resources/views/emails/tiket-layanan.blade.php
     Isi email yang dikirim ke pemohon setelah submit form Ajukan Layanan,
     tiketnya sendiri dilampirkan sebagai PDF (lihat app/Mail/ServiceRequestTicketMail.php
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 28px rgba(11,34,51,.08);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#12242E,#14839C);background-color:#12242E;padding:28px 32px;">
              <img src="{{ $logoUrl }}" alt="Pustekinfo DPR RI" height="32" style="display:block;">
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 20px;font-size:13.5px;line-height:1.7;color:#5b6b73;">
                Halo <strong>{{ $serviceRequest->nama }}</strong>, terima kasih sudah mengajukan layanan ke Pustekinfo DPR RI.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#eef6f8;border:1.5px dashed #14839C;border-radius:10px;padding:16px 20px;margin-bottom:20px;">
                ...
                <tr>
                  <td style="font-size:22px;font-weight:800;color:#12242E;letter-spacing:.03em;">{{ $serviceRequest->kode }}</td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;color:#3c4a52;margin-bottom:24px;">
                <tr>
                  ...
                  <td style="padding:6px 0;font-weight:700;">{{ $serviceRequest->jenis_layanan }}</td>
                </tr>
                <tr>
                  <td style="padding:6px 0;color:#8a97a0;">Tanggal Pengajuan</td>
                  <td style="padding:6px 0;font-weight:700;">{{ $serviceRequest->created_at->locale('id')->translatedFormat('d F Y, H:i') }} WIB</td>
                </tr>
              </table>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:22px;">
                <tr>
                  <td style="border-radius:10px;background-color:#1f9d7c;">
                    <a href="{{ $waUrl }}" style="display:inline-block;padding:13px 24px;font-size:13.5px;font-weight:700;color:#ffffff;text-decoration:none;">Lanjutkan di WhatsApp &rarr;</a>
                  </td>
                </tr>
              </table>
              @endif
