...
<body>
  ...
  <nav class="navbar">
    ...
    <ul class="nav-links">
      ...
      <li class="{{ request()->routeIs('profil') ? 'active' : '' }}"><a href="{{ route('profil') }}">Profil</a></li>
      <li class="{{ request()->routeIs('layanan') ? 'active' : '' }}"><a href="{{ route('layanan') }}">Layanan</a></li>
      <li class="{{ request()->routeIs('informasi') ? 'active' : '' }}"><a href="{{ route('informasi') }}">Informasi</a></li>
      <li class="{{ request()->routeIs('galeri') ? 'active' : '' }}"><a href="{{ route('galeri') }}">Galeri</a></li>
